...
export const EducationSection: React.FC = () => {
  return (
    <section
      id="education"
      className="relative py-20 lg:py-24 bg-[#020b16] border-t border-cyan-500/15"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-navy-mist text-sm sm:text-base mt-2">
            Industry-standard qualifications in Meta Blueprint Media Buying, advanced visual communication, and digital technology.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {educationList.map((item) => (
            <div
              key={item.id}
              className="navy-glass-card rounded-2xl p-6 border border-cyan-500/20 hover:border-cyan-400/40 transition-all duration-300 flex flex-col justify-between"
            >
              <div>
                <div className="flex items-start justify-between gap-3 mb-3">
                  ...
                  <span className="text-[11px] font-semibold px-2.5 py-1 rounded-md bg-[#031320] border border-cyan-500/20 text-navy-mist whitespace-nowrap">
                    {item.year}
                  </span>
                </div>
              ...
              <div className="pl-12 pt-3 border-t border-slate-800/80 flex items-center justify-between">
                <span className="text-[11px] text-cyan-400/80">{item.badge}</span>
                {item.verified && (
