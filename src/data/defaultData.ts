...
export const educationList: EducationItem[] = [
  ...
  {
    id: 'edu-2',
    title: 'Skill Development & Multimedia Specialization',
    titleBn: 'স্কিল ডেভেলপমেন্ট ও মাল্টিমিডিয়া কোর্স',
    institution: 'As-Sunnah Skill Development Institute (আস-সুন্নাহ স্কিল ডেভেলপমেন্ট ইনস্টিটিউট)',
    year: 'Certified',
    type: 'certification',
    description: 'Professional skill acquisition in creative media production, graphic communication, digital design, and career technology.',
    badge: 'Institute Certified',
    verified: true
  },
  {
    id: 'edu-3',
    title: 'Meta Certified Digital Marketing Associate & Media Buyer',
    titleBn: 'মেটা সার্টিফাইড ডিজিটাল মার্কেটিং ও মিডিয়া বায়িং',
    institution: 'Meta Blueprint Academy',
    year: '2024 - 2025',
    type: 'certification',
    description: 'Certified expertise in Meta campaign structure, advanced bidding strategies, audience targeting, and Conversions API setup.',
    badge: 'Verified Credential',
    verified: true
  },
  {
    id: 'edu-4',
    title: 'Professional Graphic Design & Video Editing Training',
    titleBn: 'প্রফেশনাল গ্রাফিক্স ডিজাইন ও ভিডিও এডিটিং',
    institution: 'Creative Media Training Program',
    year: '2022 - 2024',
    type: 'course',
    description: 'Hands-on practical training in Adobe Suite (Premiere, Photoshop, Illustrator, After Effects) and commercial advertising visual workflows.',
